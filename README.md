...
- **最新版（本番環境）**: https://f086ede3.aichef-595.pages.dev/
- **ランディングページ**: https://f086ede3.aichef-595.pages.dev/
- **献立作成アプリ**: https://f086ede3.aichef-595.pages.dev/app
- **APIヘルスチェック**: https://f086ede3.aichef-595.pages.dev/api/health

### 📢 最新更新（2026-01-05）

**🐛 バグ修正完了**
- ✅ 献立作成時のエラーを修正
- ✅ `budget_distribution` フィールドのバリデーション修正
- ✅ `age_band` フィールドのマッピング修正（子供の年齢帯を正しく設定）
- ✅ 必須フィールドのデフォルト値を追加

**👥 子供情報の詳細対応**
- 子供の年齢帯を正しく反映（0-2歳→preschool、3-5歳→preschool、6-12歳→elementary、13-18歳→junior_high）
- 年齢帯に応じた献立選択を準備
