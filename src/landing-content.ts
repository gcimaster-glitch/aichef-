...
<body>
    ...
    <section class="hero-section">
        ...
        <div class="hero-content">
            ...
            <div style="display: flex; gap: 1rem; justify-content: center; flex-wrap: wrap; margin-top: 2rem;">
                <button onclick="openDemoModal()" class="cta-button" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white; border: none; cursor: pointer;">
                    <i class="fas fa-magic mr-2"></i> 献立デモを試す
                </button>
    ...
    <div id="demoModal" class="demo-modal" style="display: none;">
        <div class="demo-modal-content">
            <button onclick="closeDemoModal()" class="demo-close">&times;</button>
            
            <div id="demoLoading" style="text-align: center; padding: 3rem;">
                <i class="fas fa-spinner fa-spin text-purple-600" style="font-size: 4rem; margin-bottom: 1rem;"></i>
                <h3 style="font-size: 1.5rem; color: #667eea; margin-bottom: 0.5rem;">AIが献立を作成中...</h3>
                <p style="color: #666;">3日分の献立を生成しています</p>
            </div>

            <div id="demoResult" style="display: none;">
                <h2 style="font-size: 2rem; font-weight: 700; color: #1a202c; margin-bottom: 1rem; text-align: center;">
                    <i class="fas fa-utensils text-purple-600 mr-2"></i>
                    3日分の献立ができました！
                </h2>
                <p style="text-align: center; color: #666; margin-bottom: 2rem;">
                    これはデモ版です。実際の機能はもっと充実しています。
                </p>
                
                <div id="demoMeals"></div>

                <div style="background: linear-gradient(135deg, rgba(102, 126, 234, 0.1) 0%, rgba(118, 75, 162, 0.1) 100%); padding: 2rem; border-radius: 16px; margin-top: 2rem;">
                    <h3 style="font-size: 1.5rem; font-weight: 700; color: #667eea; margin-bottom: 1rem; text-align: center;">
                        <i class="fas fa-crown mr-2"></i>会員になるともっと便利！
                    </h3>
                    <ul style="list-style: none; padding: 0; margin: 1.5rem 0;">
                        <li style="padding: 0.5rem 0; color: #333;">
                            <i class="fas fa-check text-green-600 mr-2"></i> <strong>1ヶ月分のメニュー</strong>を一括作成
                        </li>
                        <li style="padding: 0.5rem 0; color: #333;">
                            <i class="fas fa-check text-green-600 mr-2"></i> <strong>好き嫌い対応</strong>で家族みんなが満足
                        </li>
                        <li style="padding: 0.5rem 0; color: #333;">
                            <i class="fas fa-check text-green-600 mr-2"></i> <strong>アレルギー対応</strong>（簡易）で安心
                        </li>
                        <li style="padding: 0.5rem 0; color: #333;">
                            <i class="fas fa-check text-green-600 mr-2"></i> <strong>家族への献立送信</strong>機能
                        </li>
                        <li style="padding: 0.5rem 0; color: #333;">
                            <i class="fas fa-check text-green-600 mr-2"></i> <strong>レシピ保存</strong>でお気に入り管理
                        </li>
                        <li style="padding: 0.5rem 0; color: #333;">
                            <i class="fas fa-check text-green-600 mr-2"></i> <strong>買い物リスト保存・送信</strong>
                        </li>
                        <li style="padding: 0.5rem 0; color: #333;">
                            <i class="fas fa-check text-green-600 mr-2"></i> <strong>レシピサイトへのリンク</strong>機能
                        </li>
                    </ul>
                    <div style="text-align: center; margin-top: 2rem;">
                        <a href="/app" style="display: inline-block; padding: 15px 40px; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white; font-size: 1.2rem; font-weight: 600; border-radius: 50px; text-decoration: none; box-shadow: 0 10px 30px rgba(0,0,0,0.2); transition: all 0.3s ease;">
                            <i class="fas fa-user-plus mr-2"></i>今すぐ無料で会員登録
                        </a>
                        <p style="margin-top: 1rem; color: #666; font-size: 0.9rem;">
                            年間500円の寄付で、すべての機能が使い放題
                        </p>
                    </div>
                </div>
            </div>
    ...
    <section id="solution">
        ...
        <div class="solution-grid">
            ...
            <div class="solution-card">
                ...
                <h3 class="text-xl font-bold mb-3">最大4週間分を自動生成</h3>
                <p class="text-gray-600">
                    主菜・副菜・汁物の3品セット。<br>
                    700種類以上のバリエーション。
                </p>
    ...
    <section id="howto" style="background:#f9fafb;">
        <h2 class="section-title">簡単3ステップで<br>献立が完成</h2>
    ...
    <!-- 寄付CTAセクション -->
    <section id="donation" style="background:#fff8f0;padding:80px 20px;">
        <div style="max-width:900px;margin:0 auto;">
            <div style="text-align:center;margin-bottom:3rem;">
                <div style="display:inline-block;background:linear-gradient(135deg, #f59e0b 0%, #ef4444 100%);color:white;padding:8px 20px;border-radius:20px;font-size:0.9rem;font-weight:600;margin-bottom:1.5rem;">
                    <i class="fas fa-heart mr-2"></i>
                    応援プログラム
                </div>
                <h2 style="font-size:2.5rem;font-weight:700;color:#1a202c;margin-bottom:1rem;">
                    寄付で応援して、<br class="md:hidden">ずっと無料で使える
                </h2>
                <p style="font-size:1.2rem;color:#4b5563;line-height:1.8;">
                    AICHEFS AIシェフは、すべての機能が完全無料です。<br>
                    あなたの寄付が、このサービスを支え、より多くの方に献立の悩みから解放される機会を提供します。
                </p>
            </div>
            
            <div style="display:grid;grid-template-columns:repeat(auto-fit, minmax(280px, 1fr));gap:2rem;margin-bottom:3rem;">
                <!-- 寄付の特典1 -->
                <div style="background:white;padding:2rem;border-radius:16px;box-shadow:0 4px 20px rgba(0,0,0,0.08);text-align:center;">
                    <div style="font-size:3rem;margin-bottom:1rem;">
                        <i class="fas fa-infinity" style="background:linear-gradient(135deg, #667eea 0%, #764ba2 100%);-webkit-background-clip:text;-webkit-text-fill-color:transparent;"></i>
                    </div>
                    <h3 style="font-size:1.3rem;font-weight:700;color:#1a202c;margin-bottom:0.5rem;">全機能 永久無料</h3>
                    <p style="color:#6b7280;line-height:1.6;">
                        1,000円以上のご寄付で、すべての機能を制限なく、<strong>期限なし</strong>でご利用いただけます。
                    </p>
                </div>
                ...
                <div style="background:white;padding:2rem;border-radius:16px;box-shadow:0 4px 20px rgba(0,0,0,0.08);text-align:center;">
                    <div style="font-size:3rem;margin-bottom:1rem;">
                        <i class="fas fa-sparkles" style="background:linear-gradient(135deg, #667eea 0%, #764ba2 100%);-webkit-background-clip:text;-webkit-text-fill-color:transparent;"></i>
                    </div>
                    <h3 style="font-size:1.3rem;font-weight:700;color:#1a202c;margin-bottom:0.5rem;">新機能を優先体験</h3>
                    <p style="color:#6b7280;line-height:1.6;">
                        寄付者様には、新機能やプレミアムレシピを一般公開より<strong>早く</strong>お届けします。
                    </p>
                </div>
                ...
                <div style="background:white;padding:2rem;border-radius:16px;box-shadow:0 4px 20px rgba(0,0,0,0.08);text-align:center;">
                    <div style="font-size:3rem;margin-bottom:1rem;">
                        <i class="fas fa-handshake" style="background:linear-gradient(135deg, #667eea 0%, #764ba2 100%);-webkit-background-clip:text;-webkit-text-fill-color:transparent;"></i>
                    </div>
                    <h3 style="font-size:1.3rem;font-weight:700;color:#1a202c;margin-bottom:0.5rem;">サービス存続をサポート</h3>
                    <p style="color:#6b7280;line-height:1.6;">
                        あなたの支援が、運営コストを支え、<strong>持続可能</strong>なサービス提供を実現します。
                    </p>
                </div>
            </div>
            ...
            <div style="background:white;padding:2.5rem;border-radius:20px;box-shadow:0 10px 40px rgba(0,0,0,0.1);">
                <h3 style="font-size:1.5rem;font-weight:700;color:#1a202c;margin-bottom:1.5rem;text-align:center;">
                    <i class="fas fa-gift mr-2" style="color:#ef4444;"></i>
                    応援金額を選ぶ
                </h3>
                <div style="display:grid;grid-template-columns:repeat(auto-fit, minmax(150px, 1fr));gap:1rem;margin-bottom:2rem;">
                    <button onclick="selectDonationAmount(1000)" class="donation-amount-btn" style="padding:1.5rem 1rem;background:#f3f4f6;border:2px solid #e5e7eb;border-radius:12px;font-size:1.2rem;font-weight:700;color:#1a202c;cursor:pointer;transition:all 0.3s ease;">
                        ¥1,000
                    </button>
                    <button onclick="selectDonationAmount(3000)" class="donation-amount-btn" style="padding:1.5rem 1rem;background:#f3f4f6;border:2px solid #e5e7eb;border-radius:12px;font-size:1.2rem;font-weight:700;color:#1a202c;cursor:pointer;transition:all 0.3s ease;">
                        ¥3,000
                    </button>
                    <button onclick="selectDonationAmount(5000)" class="donation-amount-btn" style="padding:1.5rem 1rem;background:#f3f4f6;border:2px solid #e5e7eb;border-radius:12px;font-size:1.2rem;font-weight:700;color:#1a202c;cursor:pointer;transition:all 0.3s ease;">
                        <div style="background:linear-gradient(135deg, #f59e0b, #ef4444);color:white;padding:2px 8px;border-radius:8px;font-size:0.7rem;margin-bottom:4px;">おすすめ</div>
                        ¥5,000
                    </button>
                    <button onclick="selectDonationAmount(10000)" class="donation-amount-btn" style="padding:1.5rem 1rem;background:#f3f4f6;border:2px solid #e5e7eb;border-radius:12px;font-size:1.2rem;font-weight:700;color:#1a202c;cursor:pointer;transition:all 0.3s ease;">
                        ¥10,000
                    </button>
                </div>
                <div style="text-align:center;">
                    <a href="/pricing.html" id="donate-link" style="display:inline-block;padding:18px 48px;background:linear-gradient(135deg, #f59e0b 0%, #ef4444 100%);color:white;font-size:1.2rem;font-weight:700;border-radius:50px;text-decoration:none;transition:all 0.3s ease;box-shadow:0 10px 30px rgba(239,68,68,0.3);" onmouseover="this.style.transform='translateY(-3px)';this.style.boxShadow='0 15px 40px rgba(239,68,68,0.4)'" onmouseout="this.style.transform='translateY(0)';this.style.boxShadow='0 10px 30px rgba(239,68,68,0.3)'">
                        <i class="fas fa-heart mr-2"></i>
                        寄付で応援する
                    </a>
            ...
            <!-- 寄付者の声（将来的に追加可能） -->
            <div style="margin-top:3rem;text-align:center;padding:2rem;background:rgba(102, 126, 234, 0.05);border-radius:16px;">
                <p style="font-size:1.1rem;color:#4b5563;font-style:italic;line-height:1.8;">
                    「毎日の献立作りから解放されて、家族との時間が増えました。<br>
                    このサービスを続けてほしいので、喜んで応援します！」
                </p>
                <p style="margin-top:1rem;font-size:0.9rem;color:#6b7280;font-weight:600;">
                    - 寄付者様の声
                </p>
            </div>
        </div>
    ...
    <script>
        // 寄付金額選択
        let selectedDonationAmount = 5000; // デフォルト金額
        ...
        function selectDonationAmount(amount) {
            ...
            // 選択されたボタンをハイライト
            event.target.closest('button').style.background = 'linear-gradient(135deg, #667eea 0%, #764ba2 100%)';
            ...
            // 寄付ページへ遷移時にamountをクエリパラメータで渡す
            const donateLink = document.getElementById('donate-link');
            if (donateLink) {
                donateLink.href = '/pricing.html?amount=' + amount;
            }
        }
        ...
        async function openDemoModal() {
            ...
            // 3日分の献立を生成
            try {
                const response = await fetch('/api/demo/generate-meals', {
                    method: 'POST',
                    headers: {
                ...
                displayDemoMeals(data.meals);
                
                loading.style.display = 'none';
                result.style.display = 'block';
            } catch (error) {
                console.error('Error generating demo meals:', error);
                loading.innerHTML = '<p style="color: #ef4444;">エラーが発生しました。もう一度お試しください。</p>';
            }
        }

        function displayDemoMeals(meals) {
            const container = document.getElementById('demoMeals');
            container.innerHTML = '';
            
            meals.forEach((meal, index) => {
                const mealCard = document.createElement('div');
                mealCard.className = 'demo-meal-card';
                
                const dayLabel = ['1日目', '2日目', '3日目'][index];
                const date = new Date();
                ...
                if (meal.main) {
                    recipesHTML += \`
                        <div class="demo-recipe-item">
                            <div style="width: 50px; height: 50px; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); border-radius: 12px; display: flex; align-items: center; justify-content: center; margin-right: 1rem;">
                                <i class="fas fa-drumstick-bite" style="color: white; font-size: 1.5rem;"></i>
                            </div>
                            <div style="flex: 1;">
                                <p style="font-size: 0.9rem; color: #666; margin-bottom: 0.25rem;">主菜</p>
                                <p style="font-size: 1.1rem; font-weight: 600; color: #1a202c;">\${meal.main.title}</p>
                                <p style="font-size: 0.85rem; color: #999; margin-top: 0.25rem;">
                                    <i class="fas fa-clock mr-1"></i>\${meal.main.time_min}分
                                </p>
                            </div>
                        </div>
                    \`;
                    ...
                    recipesHTML += \`
                        <div class="demo-recipe-item">
                            <div style="width: 50px; height: 50px; background: linear-gradient(135deg, #10b981 0%, #059669 100%); border-radius: 12px; display: flex; align-items: center; justify-content: center; margin-right: 1rem;">
                                <i class="fas fa-carrot" style="color: white; font-size: 1.5rem;"></i>
                            </div>
                            <div style="flex: 1;">
                                <p style="font-size: 0.9rem; color: #666; margin-bottom: 0.25rem;">副菜</p>
                                <p style="font-size: 1.1rem; font-weight: 600; color: #1a202c;">\${meal.side.title}</p>
                                <p style="font-size: 0.85rem; color: #999; margin-top: 0.25rem;">
                                    <i class="fas fa-clock mr-1"></i>\${meal.side.time_min}分
                                </p>
                            </div>
                        </div>
                    \`;
                    ...
                    recipesHTML += \`
                        <div class="demo-recipe-item">
                            <div style="width: 50px; height: 50px; background: linear-gradient(135deg, #f59e0b 0%, #d97706 100%); border-radius: 12px; display: flex; align-items: center; justify-content: center; margin-right: 1rem;">
                                <i class="fas fa-bowl-food" style="color: white; font-size: 1.5rem;"></i>
                            </div>
                            <div style="flex: 1;">
                                <p style="font-size: 0.9rem; color: #666; margin-bottom: 0.25rem;">汁物</p>
                                <p style="font-size: 1.1rem; font-weight: 600; color: #1a202c;">\${meal.soup.title}</p>
                                <p style="font-size: 0.85rem; color: #999; margin-top: 0.25rem;">
                                    <i class="fas fa-clock mr-1"></i>\${meal.soup.time_min}分
                                </p>
                            </div>
                        </div>
                    \`;
                ...
                const totalTime = (meal.main?.time_min || 0) + (meal.side?.time_min || 0) + (meal.soup?.time_min || 0);
                ...
                mealCard.innerHTML = \`
                    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 1rem; padding-bottom: 1rem; border-bottom: 2px solid #e5e7eb;">
                        <div>
                            <h3 style="font-size: 1.5rem; font-weight: 700; color: #667eea; margin-bottom: 0.25rem;">
                                \${dayLabel}
                            </h3>
                            <p style="color: #666; font-size: 0.9rem;">\${dateStr}（\${['日', '月', '火', '水', '木', '金', '土'][date.getDay()]}）</p>
                        </div>
                        <div style="text-align: right;">
                            <p style="font-size: 0.85rem; color: #999;">合計調理時間</p>
                            <p style="font-size: 1.3rem; font-weight: 700; color: #667eea;">
                                <i class="fas fa-clock mr-1"></i>\${totalTime}分
                            </p>
                        </div>
                    </div>
                    \${recipesHTML}
