...
<body>
    ...
    <nav class="nav">
        <div class="nav-content">
            <a href="/" class="nav-logo">
                <i class="fas fa-utensils"></i> Aメニュー
            </a>
    ...
    <section class="hero-section">
        <div class="hero-content">
            <h1 class="hero-title">考えなくていい。<br>悩まなくていい。</h1>
    ...
    <!-- ソリューションセクション -->
    <section id="solution">
        <h2 class="section-title">Aメニューが<br>すべて解決します</h2>
    ...
    <footer style="background:#1a202c;color:white;padding:60px 20px;">
        <div style="max-width:1200px;margin:0 auto;">
            ...
            <div style="text-align:center;margin-top:3rem;padding-top:2rem;border-top:1px solid rgba(255,255,255,0.1);">
                <p style="opacity:0.6;">&copy; 2026 Aメニュー. All rights reserved.</p>
            </div>
        </div>
    </footer>
